# Go OpenAI
[![Go Reference](https://pkg.go.dev/badge/github.com/cogidoo2015/go-openai-2.svg)](https://pkg.go.dev/github.com/cogidoo2015/go-openai-2)
[![Go Report Card](https://goreportcard.com/badge/github.com/cogidoo2015/go-openai-2)](https://goreportcard.com/report/github.com/cogidoo2015/go-openai-2)
...
```
go get github.com/cogidoo2015/go-openai-2
```
...
import (
	"context"
	"fmt"
	openai "github.com/cogidoo2015/go-openai-2"
)
...
See also: https://pkg.go.dev/github.com/cogidoo2015/go-openai-2#ClientConfig
</details>
...
import (
	...
	"github.com/cogidoo2015/go-openai-2"
)
...
**Related Issues:**  
[omitempty option of request struct will generate incorrect request when parameter is 0.](https://github.com/cogidoo2015/go-openai-2/issues/9)
...
**Related Issues:**  
[Is it possible to join the implementation of GPT3 Tokenizer](https://github.com/cogidoo2015/go-openai-2/issues/62)

## Contributing

By following [Contributing Guidelines](https://github.com/cogidoo2015/go-openai-2/blob/master/CONTRIBUTING.md), we hope to ensure that your contributions are made smoothly and efficiently.

## Thank you

We want to take a moment to express our deepest gratitude to the [contributors](https://github.com/cogidoo2015/go-openai-2/graphs/contributors) and sponsors of this project:
